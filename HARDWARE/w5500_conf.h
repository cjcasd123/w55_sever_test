...
#define WIZ_SPIx_GPIO_CLK       RCC_AHB1Periph_GPIOA	  	  /* GPIO端口时钟                 */
...
#define WIZ_SPIx_MISO           GPIO_Pin_7						   	  /* 定义W5500的MISO管脚          */
#define WIZ_SPIx_MOSI           GPIO_Pin_6						   	  /* 定义W5500的MOSI管脚          */



#define WIZ_SPIx_SCS          GPIO_Pin_4						 	    /* 定义W5500的片选管脚          */
#define WIZ_SPIx_SCS_PORT     GPIOA									 	    /* GPIO端口                     */
#define WIZ_SPIx_SCS_CLK      RCC_AHB1Periph_GPIOA	 	    /* GPIO端口时钟                 */

#define WIZ_RESET             GPIO_Pin_3									/* 定义W5500的RESET管脚         */
#define WIZ_SPIx_RESET_PORT   GPIOA									  	  /* GPIO端口                     */
#define WIZ_SPIx_RESET_CLK    RCC_AHB1Periph_GPIOA	 	    /* GPIO端口时钟                 */

#define WIZ_INT               GPIO_Pin_2									/* 定义W5500的INT管脚           */
#define WIZ_SPIx_INT_PORT     GPIOA									      /* GPIO端口                     */
#define WIZ_SPIx_INT_CLK      RCC_AHB1Periph_GPIOA	      /* GPIO端口时钟                 */
...
extern uint8 buff[1024];                                                                /*定义2K的数组*/
extern uint8 date1;
/*MCU配置相关函数*/
//void gpio_for_w5500_config(void);	/* 初始化W5500的GPIO */
//void gpio_w5500_config(void);
...
void gpio_for_w5500_config(void); /* W5500 IO 口设置 */
/*W5500SPI相关函数*/
